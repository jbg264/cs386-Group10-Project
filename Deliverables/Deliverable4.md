...
- Print Screen: Not applicable
  ...
  Requirement: As a potential user, I want to be able to create an account
- Issue: https://github.com/rmwood367/cs386-Group10-Project/issues/66
- Pull Request: Pending
- Implemented by: Blase Gornick and Latisha Talayumptewa
